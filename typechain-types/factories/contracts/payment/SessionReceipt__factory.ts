...
import type {
  SessionReceipt,
  SessionReceiptInterface,
} from "../../../contracts/payment/SessionReceipt";
...
type SessionReceiptConstructorParams =
  | [signer?: Signer]
  | ConstructorParameters<typeof ContractFactory>;

const isSuperArgs = (
  xs: SessionReceiptConstructorParams
): xs is ConstructorParameters<typeof ContractFactory> => xs.length > 1;

export class SessionReceipt__factory extends ContractFactory {
  constructor(...args: SessionReceiptConstructorParams) {
    if (isSuperArgs(args)) {
      super(...args);
    } else {
  ...
  override connect(runner: ContractRunner | null): SessionReceipt__factory {
    return super.connect(runner) as SessionReceipt__factory;
  }

  static readonly bytecode = _bytecode;
  static readonly abi = _abi;
  static createInterface(): SessionReceiptInterface {
    return new Interface(_abi) as SessionReceiptInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): SessionReceipt {
    return new Contract(address, _abi, runner) as unknown as SessionReceipt;
  }
}
